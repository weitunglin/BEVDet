...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        tasks=[
            ...
            dict(num_class=2, class_names=['truck']),
            dict(num_class=2, class_names=['bus']),
            dict(num_class=1, class_names=['dontcare']),
...
test_pipeline = [
    dict(type='PrepareImageInputs', data_config=data_config, ego_cam='image_front_bottom_60'),
    dict(
        type='LoadAnnotationsBEVDepth',
        bda_aug_conf=bda_aug_conf,
        classes=class_names,
